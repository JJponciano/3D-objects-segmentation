...
void test_cloud()
{
    ...
    cloud_manip::scale_cloud(cloud_xyzrgb, 1, 100000, 1, 0.005);
    ...
    cloud_manip::scale_cloud(final_cloud, 1, (1.0/100000.0), 1, 0.005);
    std::cout << "Writing results into txt file... " << std::flush;
    pcloud_io::export_cloud("cloud_final.txt", final_cloud);
